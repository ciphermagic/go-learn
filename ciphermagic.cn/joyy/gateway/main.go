...
func loadProxyList() {
	dataList := []Proxy{
		{Remark: "集群列表", Prefix: "/cdc-admin-clusters", Upstream: "https://cdc-admin-web-test.inshopline.com", RewritePrefix: "/api/dev/config/taskGroup/clusters"},
		{Remark: "任务状态", Prefix: "/cdc-admin-status", Upstream: "https://cdc-admin-web-test.inshopline.com", RewritePrefix: "/api/dev/config/taskGroup/status"},
	}
